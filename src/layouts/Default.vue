    ...
    <footer class="bg-primary text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:aadimator@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a
              ...
              class="text-white hover:text-gray-400"
            >
              <svg width="26" height="25" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <li>
            <a
              href="https://instagram.com/aadimator"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
