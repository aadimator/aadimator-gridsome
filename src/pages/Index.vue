<template>
  <Layout>
    ...
    <div class="container-inner mx-auto">
      ...
      >Greetings! I'm Aadam. I spend my days designing and developing web applications, and teaching about it on YouTube. I specialize in the Laravel PHP framework on the backend, Vue.js on the frontend and Tailwind CSS for styling. I’ve decided to focus all my content into video on YouTube, so there will be no blog on this website (for now). Subscribe on YouTube to stay updated on what I’m up to.</p>
        ...
        <ul class="text-lg sm:text-xl">
          <li class="checkmark mb-6">
            ...
            <div class="text-lg text-gray-600">
              ...
              <a href="https://github.com/aadimator/khoji">Github Link</a>
            </div>
          </li>
          <li class="checkmark mb-6">
        ...
        <div class="w-4/5 mx-auto mb-8">
          ...
          <form action="#">
            <div class="flex flex-col sm:flex-row">
              ...
              <button data-element="submit" class="flex-2 w-40 uppercase bg-primary text-white rounded sm:rounded-l-none text-lg py-3 px-8 tracking-wide shadow focus:outline-none hover:bg-primary-dark focus:bg-primary-dark z-10 w-full sm:w-auto mt-4 sm:mt-0">
                <span>Subscribe</span>
              </button>
            </div>
          </form>
